function out = FLIRCaptutre
%FLIRCAPTUTRE Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, FLIRCAPTUTRE.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, FLIRCaptutre, at the MATLAB command prompt.
%   
%   The code file, FLIRCAPTUTRE.M and its associated MAT-file, FLIRCAPTUTRE.MAT (if
...
try
    MATvar = load('C:\Users\ftal\OneDrive - Technion\Documents\MATLAB\UTEM Matlab\FLIRCaptutre');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\ftal\OneDrive - Technion\Documents\MATLAB\UTEM Matlab\FLIRCaptutre.mat.
if (MATLoaded)
